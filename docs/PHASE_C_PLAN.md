...
> consumed by decision / approvals / sim_trading as `0039`–`0041`, then `0042`=schedule_cron;
> **next free: `0043`**). Details:
...
> **next free: `0043`** (see OI-C7). Leftovers tracked in `docs/OPEN_ITEMS.md` (`OI-C1`–`OI-C13`,
