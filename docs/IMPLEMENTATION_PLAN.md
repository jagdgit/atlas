...
│   │   #   models/learning.py (LearningEvent + Experience), repositories/learning_repo.py,
│   │   #   services/learning_service.py (learning cap: observe_job/apply/revert/recall; governed, reversible)
│   │
...
│   │                         #   websearch/download/scholar/youtube/code/python/report/
│   │                         #   verify/learn/tool/backup
│   │
